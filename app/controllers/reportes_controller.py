...
def reporte_ingresos(db: DbSession):
    ...
    return cache_store.cached("reportes:ingresos", service.list_ingresos_por_dia, ttl_seconds=60)
...
def reporte_alertas_stock(db: DbSession):
    ...
    return cache_store.cached("reportes:alertas-stock", service.list_alertas_stock, ttl_seconds=60)
...
def reporte_ordenes(db: DbSession):
    ...
    return cache_store.cached("reportes:ordenes", service.list_resumen, ttl_seconds=60)
...
def dashboard(db: DbSession):
    ...
    return cache_store.cached("reportes:dashboard", build_dashboard, ttl_seconds=60)
